...
写在最后
====================================
这是我第一次搭建自己的网站，当看到输入一个网址跃现出一个自己搭建的网站的时候还是很兴奋的。虽然大多数的内容还是借鉴的别人的东西，但是整个流程还是自己完成的，还是感觉很不错的。

不过，在搭建完以后还是遇到了问题，在本地网页显示很正常，但是一放到github上就不能渲染，也不能点击链接，也不知道是什么原因，这也是知其然不知其所以然的后果。